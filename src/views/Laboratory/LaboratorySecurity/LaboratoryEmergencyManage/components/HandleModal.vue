...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.laboratoryEmergencyManage.handleDate.visible,
        ruleForm: state => state.laboratoryEmergencyManage.handleDate.ruleForm,
        rules: state => state.laboratoryEmergencyManage.handleDate.rules,
        eventType: state => state.laboratoryEmergencyManage.eventType,
        feedbackPerson: state => state.laboratoryEmergencyManage.feedbackPerson
      })
    },
    methods: {
