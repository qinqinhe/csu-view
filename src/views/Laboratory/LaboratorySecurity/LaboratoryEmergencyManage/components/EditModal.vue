...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.laboratoryEmergencyManage.editDate.visible,
        ruleForm: state => state.laboratoryEmergencyManage.editDate.ruleForm,
        rules: state => state.laboratoryEmergencyManage.editDate.rules,
