  ...
  <div class="modal-dialog">
    ...
    >
      <Surveillance
        :width="560"
        :height="640"
        :preview="detailVisible"
        cameraIndexCode="4f38daa2aba34da1aa60ac0c65b1d84d"
      />
...
<script>
  ...
  import Surveillance from '@/components/Surveillance/index'
  ...
  export default {
    ...
    mounted () {
      ...
      setTimeout(() => this.startPreview = true, 100)
