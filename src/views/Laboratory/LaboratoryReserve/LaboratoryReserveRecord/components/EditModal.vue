    ...
    >
      ...
      >
        <section class="dialog-from-content">
          <el-form-item label="实验室" prop="reserveObjectName">
            <el-input
          ...
          <el-form-item label="状态" prop="auditStatus">
            <el-select v-model="ruleForm.auditStatus" placeholder="请选择状态" disabled>
              <el-option
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.laboratoryReserveRecord.editDate.visible,
        ruleForm: state => state.laboratoryReserveRecord.editDate.ruleForm,
        rules: state => state.laboratoryReserveRecord.editDate.rules,
        
        students: state => state.laboratoryReserveRecord.editDate.students,
        auditStatusSelect: state => state.laboratoryReserveRecord.editDate.auditStatusSelect,
        laboratoryType: state => state.laboratoryReserveRecord.laboratoryType
      })
    },
    methods: {
