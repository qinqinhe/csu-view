...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        ruleForm: state => state.laboratoryReserveRecord.conditionsForm.ruleForm,
        auditStatusSelect: state => state.laboratoryReserveRecord.conditionsForm.auditStatusSelect
      }),
      ...mapGetters('laboratoryReserveRecord', [
        'pickerOptionsBegin',
        'pickerOptionsFinish'
      ])
    },
