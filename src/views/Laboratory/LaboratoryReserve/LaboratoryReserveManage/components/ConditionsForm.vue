<template>
  <el-form
    ...
    :model="ruleForm"
  >
    <el-form-item label="名称" prop='laboratoryName' class="both">
      <el-input
        placeholder="请输入名称"
        size="medium"
        v-model='ruleForm.laboratoryName'
      />
    </el-form-item>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        ruleForm: state => state.laboratoryReserveManage.conditionsForm.ruleForm,
        period: state => state.laboratoryReserveManage.conditionsForm.period,
        pickerOptions: state => state.laboratoryReserveManage.pickerOptions
      })
    },
    methods: {
