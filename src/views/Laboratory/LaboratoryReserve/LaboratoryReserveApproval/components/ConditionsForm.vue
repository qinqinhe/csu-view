...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        ruleForm: state => state.laboratoryReserveApproval.conditionsForm.ruleForm,
        auditStatusSelect: state => state.laboratoryReserveApproval.conditionsForm.auditStatusSelect
      }),
      ...mapGetters('laboratoryReserveApproval', [
        'pickerOptionsBegin',
        'pickerOptionsFinish'
      ])
    },
