...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.laboratoryReserveApproval.editDate.visible,
        ruleForm: state => state.laboratoryReserveApproval.editDate.ruleForm,
        rules: state => state.laboratoryReserveApproval.editDate.rules,
        
        students: state => state.laboratoryReserveApproval.editDate.students,
        auditStatusSelect: state => state.laboratoryReserveApproval.editDate.auditStatusSelect
      })
    },
    methods: {
