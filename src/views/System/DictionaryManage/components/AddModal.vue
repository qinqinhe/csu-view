      ...
      >
        <section class="dialog-from-content">
          <el-form-item label="字典编码" prop="dictionaryTypeCode">
            <el-input v-model="ruleForm.dictionaryTypeCode" placeholder="请输入字典编码"/>
          </el-form-item>
          <el-form-item label="字典名称" prop="dictionaryTypeName">
            <el-input v-model="ruleForm.dictionaryTypeName" placeholder="请输入字典名称"/>
          </el-form-item>
          ...
          <section class="table-add">
            <section class="table-add-head flex">
              ...
              <el-button type="primary" size="medium" @click='addDateAddTemplate'>添加字典</el-button>
            </section>
            <el-table
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.dictionaryManage.addDate.visible,
        ruleForm: state => state.dictionaryManage.addDate.ruleForm,
        rules: state => state.dictionaryManage.addDate.rules,
        dictionaryTypeStatusSelect: state => state.dictionaryManage.addDate.dictionaryTypeStatusSelect
      })
    },
    methods: {
