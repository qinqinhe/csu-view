        ...
        <section class="dialog-from-content">
          ...
          <el-form-item label="所属子系统" prop="belongSubsystem">
            <el-select
              ...
              v-if='ruleForm.belongSystem==="7864386838056689665"'
            >
              <el-option
            ...
            <el-select
              v-model="ruleForm.belongSubsystem"
              placeholder="请选择所属子系统"
              v-else-if='ruleForm.belongSystem==="7864386838056689664"'
            >
              <el-option
            ...
            <el-select v-model="ruleForm.belongSubsystem" placeholder="请选择所属子系统" v-else>
              <el-option
                v-for="item in securitySystemSelect"
                :key="item.dictionaryDataInfoId"
                :label="item.dictionaryValue"
          ...
          <el-form-item label="位置" prop="palceParentNames">
            <el-input :value="ruleForm.palceParentNames" @focus="TreeChooseState=true" placeholder="请选择位置"/>
          </el-form-item>
        </section>
