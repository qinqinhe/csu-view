      ...
      <section class="main-table">
        <section class="main-table-con">
          ...
          >
            ...
            <el-table-column prop="guestIdentificationNumber" label="来访者身份证号码" align='center' width='180'/>
            <el-table-column prop="guestName" label="来访者姓名" align='center'/>
            <el-table-column prop="guestPhoneNumber" label="来访者电话" align='center' width='120'/>
            ...
            <el-table-column prop="confirmationMethod" label="确认方式" align='center'>
              <template slot-scope="scope">
                <span v-if='scope.row.confirmationMethod === "1"' :style='{color: color.green}'>电话确认</span>
                <span v-else :style='{color: color.blue}'>消息确认</span>
              </template>
            </el-table-column>
            <el-table-column label="操作" align='center' width='180'>
              <template slot-scope="scope">
                <el-button
                  ...
                  v-if='(scope.row.confirmationStatus === "1") && !scope.row.departureTime'
                >离开
                </el-button>
                <span v-else>-</span>
              </template>
  ...
  export default {
    ...
    methods: {
      ...
      inquiry () {
        ...
        this.webapi({
          url: '/guard/api/CollegeVisitRecord/queryVisitRecord ',
          data: {
            ...data
          }
        }).then(res => {
      ...
      delApi (InfoId) {
        this.webapi({
          url: '/guard/api/CollegeVisitRecord/outForVisitman',
          data: {
