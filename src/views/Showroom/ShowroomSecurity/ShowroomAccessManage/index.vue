      ...
      <section class="main-from">
        <el-form ref="form" label-width="95px" :model="ruleForm">
          <el-form-item label="会议室名称">
            <el-input placeholder="会议室名称" size="medium" v-model="ruleForm.meetingRoomName"></el-input>
          </el-form-item>
      ...
      <section class="main-table">
        <!-- <section class="main-table-con">
          <el-table :data="tableData" height="100%" border>
            ...
            <el-table-column prop="showroomName" label="陈列室名称" align="center" />
            <el-table-column prop="accessUserName" label="姓名" align="center" />
            <el-table-column prop="phoneNumber" label="联系方式" width="150" align="center" />
            <el-table-column prop="enterDate" label="进入时间" align="center" />
            <el-table-column prop="outDate" label="离开时间" align="center" />
            <el-table-column prop="meetingRoomStatus" label="状态" align="center">
              <template slot-scope="scope">
							<span v-if='scope.row.outDate' style='color:#17c67a'>已出</span>
        ...
        <section class="main-table-con">
          <el-table :data="tableData" height="100%" border tooltip-effect="dark">
            ...
            <el-table-column prop="showroomAdminUserName" label="管理员" align="center" />
            <el-table-column prop="showroomAdminPhone" label="管理员联系电话" align="center" />
            <el-table-column prop="accessUserName" label="出入人名字" align="center" />
            <el-table-column prop="phoneNumber" label="出入人电话" align="center" />
        ...
        disabledDate: time => {
          ...
          if (this.ruleForm.searchFinishTime) {
            return (
              ...
              time.getTime() >
                new Date(this.ruleForm.searchFinishTime).getTime()
            );
          } else {
      ...
      return {
        disabledDate: time => {
          ...
          if (this.ruleForm.searchBeginTime) {
            return (
              time.getTime() > curDate ||
              time.getTime() < new Date(this.ruleForm.searchBeginTime).getTime()
            );
          } else {
            return time.getTime() > curDate;
          }
