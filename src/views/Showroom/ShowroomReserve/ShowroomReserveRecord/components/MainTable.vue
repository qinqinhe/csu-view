<template>
  ...
  >
    ...
    <el-table-column prop="applyTime" label="申请时间" align='center' width='180'/>
    <el-table-column label="使用时间段" align='center' width='380'>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        tableData: state => state.showroomReserveRecord.tableData
      })
    },
    methods: {
