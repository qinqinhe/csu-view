        ...
        <ul>
          ...
          <li class="flex">
            ...
            <p class="text">
              ...
              <span class="green" v-if='ruleForm.auditStatus === "1"'>已通过</span>
              <span class="red" v-if='ruleForm.auditStatus === "2"'>拒绝</span>
            </p>
          </li>
          <li class="flex">
            <p class="title">备注：</p>
          ...
          <li>
            ...
            <ul class="flex reserveUser">
              <li v-for='(item, index) in ruleForm.reserveUser' :key='index'>
                {{ item.userName }}
              </li>
            </ul>
          </li>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.showroomReserveRecord.detailDate.visible,
        ruleForm: state => state.showroomReserveRecord.detailDate.ruleForm
