...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.showroomReserveRecord.editDate.visible,
        ruleForm: state => state.showroomReserveRecord.editDate.ruleForm,
        rules: state => state.showroomReserveRecord.editDate.rules,
        
        students: state => state.showroomReserveRecord.editDate.students,
        auditStatusSelect: state => state.showroomReserveRecord.editDate.auditStatusSelect
      })
    },
    methods: {
