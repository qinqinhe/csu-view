...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        ruleForm: state => state.showroomReserveRecord.conditionsForm.ruleForm,
        auditStatusSelect: state => state.showroomReserveRecord.conditionsForm.auditStatusSelect
      }),
      ...mapGetters('showroomReserveRecord', [
        'pickerOptionsBegin',
        'pickerOptionsFinish'
      ])
    },
