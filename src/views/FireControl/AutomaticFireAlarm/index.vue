      ...
      <section class="main-table">
        <section class="main-table-con">
          ...
          >
            ...
            <el-table-column prop="deviceNormalValue" align='center' label="正常值"/>
            <el-table-column align='center' label="正常范围">
              <template slot-scope="scope">
                <span>{{ scope.row.lowerLimit }} - {{ scope.row.toplimit }}</span>
              </template>
            </el-table-column>
            <el-table-column align='center' label="异常时间">
              <template slot-scope="scope">
                <span>{{ scope.row.warrantyDeadline }}</span>
              </template>
            </el-table-column>
          </el-table>
        </section>
