...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.inspectItem.addDate.visible,
        ruleForm: state => state.inspectItem.addDate.ruleForm,
        rules: state => state.inspectItem.addDate.rules,
        inspectItemStatusSelect: state => state.inspectItem.addDate.inspectItemStatusSelect
      })
    },
    methods: {
