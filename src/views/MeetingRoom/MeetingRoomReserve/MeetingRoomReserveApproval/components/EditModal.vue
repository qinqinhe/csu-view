...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.meetingRoomReserveApproval.editDate.visible,
        ruleForm: state => state.meetingRoomReserveApproval.editDate.ruleForm,
        rules: state => state.meetingRoomReserveApproval.editDate.rules,
        
        students: state => state.meetingRoomReserveApproval.editDate.students,
        auditStatusSelect: state => state.meetingRoomReserveApproval.editDate.auditStatusSelect
      })
    },
    methods: {
