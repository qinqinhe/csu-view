...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        ruleForm: state => state.meetingRoomReserveApproval.conditionsForm.ruleForm,
        auditStatusSelect: state => state.meetingRoomReserveApproval.conditionsForm.auditStatusSelect
      }),
      ...mapGetters('meetingRoomReserveApproval', [
        'pickerOptionsBegin',
        'pickerOptionsFinish'
      ])
    },
