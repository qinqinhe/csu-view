<template>
  <el-form
    ...
    label-width="95px"
    :model="ruleForm">
    <el-form-item label="名称" prop='meetingRoomName' class="both">
      <el-input
        placeholder="请输入名称"
        size="medium"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        ruleForm: state => state.meetingRoomReserveRecord.conditionsForm.ruleForm,
        auditStatusSelect: state => state.meetingRoomReserveRecord.conditionsForm.auditStatusSelect
      }),
      ...mapGetters('meetingRoomReserveRecord', [
        'pickerOptionsBegin',
        'pickerOptionsFinish'
      ])
    },
