    ...
    >
      ...
      >
        <section class="dialog-from-content">
          <el-form-item label="会议室" prop="reserveObjectName">
            <el-input
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.meetingRoomReserveRecord.editDate.visible,
        ruleForm: state => state.meetingRoomReserveRecord.editDate.ruleForm,
        rules: state => state.meetingRoomReserveRecord.editDate.rules,
        
        students: state => state.meetingRoomReserveRecord.editDate.students,
        auditStatusSelect: state => state.meetingRoomReserveRecord.editDate.auditStatusSelect
      })
    },
    methods: {
      ...mapActions('meetingRoomReserveRecord', [
