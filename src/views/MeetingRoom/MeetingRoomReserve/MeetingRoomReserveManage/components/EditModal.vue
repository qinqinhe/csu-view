...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState({
        visible: state => state.meetingRoomReserveManage.editDate.visible,
        ruleForm: state => state.meetingRoomReserveManage.editDate.ruleForm,
        rules: state => state.meetingRoomReserveManage.editDate.rules,
        
        students: state => state.meetingRoomReserveManage.editDate.students
      })
    },
    methods: {
