      ...
      >
        <section class="dialog-from-content">
          ...
          <el-form-item label="会议室状态" prop="meetingRoomStatus">
            ...
            >
              <el-option
                v-for="(item) in meetingRoomStatusSel"
                :key="item.label"
                :label="item.label"
                :value="item.value"
              />
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      infoDetail () {
        this.webapi({
          url: `/meeting/api/meetingRoom/queryMeetingRoomInfoDetail  `,
          data: {
            meetingRoomInfoId: this.infoId
          }
        }).then(res => {
      ...
      addMenu () {
        ...
        this.webapi({
          url: '/meeting/api/meetingRoom/updateMeetingRoom',
          data: {
            ...this.ruleForm
          }
        }).then(res => {
