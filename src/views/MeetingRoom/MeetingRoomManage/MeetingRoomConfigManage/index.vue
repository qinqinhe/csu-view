...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      ...mapActions('meetingRoomConfigManage', [
        'meetingRoomchange'
      ]),
      edit (infoId) {
        this.infoId = infoId
      ...
      meetingRoomInfo () {
        this.webapi({
          url: '/meeting/api/meetingRoom/queryNotConfiguredMeetingRoomInfo'
        }).then(res => {
          const {
            resultCode,
            data,
      ...
      inquiry () {
        ...
        this.webapi({
          url: '/meeting/api/timeArrangeConfig/queryTimeArrangeConfigByPage',
          data: {
            ...page
          }
        }).then(res => {
      ...
      delApi (InfoId) {
        this.webapi({
          url: '/meeting/api/timeArrangeConfig/deleteTimeArrangeConfig',
          data: {
